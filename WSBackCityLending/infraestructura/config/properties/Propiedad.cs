...
namespace WSBackCityLending.infraestructura.config.properties
{
    public class Propiedad
    {
        ...
        private Propiedad()
        {
            try
            {
                ...
                string versionFilePath = Path.Combine(basePath, "infraestructura", "config", "properties", "version.properties");
                string globalFilePath = Path.Combine(basePath, "infraestructura", "config", "properties", "param.properties");
        ...
        public string GetBDJdbc() => propGlobal.TryGetValue("BD.JDBC", out var jdbc) ? jdbc : "N/A";
        ...
        public string GetBDDataBase() => propGlobal.TryGetValue("BD.DATABASE", out var db) ? db : "N/A";
        ...
        public static void Main()
        {
            ...
            Console.WriteLine($"PARAM= {propiedad.GetVersion()} {propiedad.GetBDJdbc()} {propiedad.GetBDUsuario()} {propiedad.GetBDClave()}");
         }
      }
    }
